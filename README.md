...
**Owner:** myee111
**Migrated from:** https://github.com/rhpds/zt-satellite-lightspeed-install
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/rh1-lb2075c-sat-lightspeed`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/rh1-lb2075c-sat-lightspeed
   ```
3. `cd rh1-lb2075c-sat-lightspeed`
